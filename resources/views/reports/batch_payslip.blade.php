...
<head>
    ...
    <style>
        ...
        th, td { border: 1px solid #052923ff; padding: 6px; text-align: left; }
        th { background-color: #180202ff; font-weight: bold; }
        .footer { margin-top: 20px; text-align: right; font-size: 10px; padding-top: 10px; border-top: 1px solid #ddd; }
        .summary-section { background-color: #032018ff; padding: 12px; border-radius: 5px; margin-bottom: 15px; }
        .summary-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 10px; margin-bottom: 10px; }
        .summary-item { background-color: #033546ff; padding: 8px; border-radius: 4px; text-align: center; }
